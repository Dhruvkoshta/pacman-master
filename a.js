...
class GameCoordinator {
	...
	preloadAssets() {
		return new Promise((resolve) => {
			...
			const imgSources = [
				...
				`${imgBase}pickups/powerPellet1.svg`,
				`${imgBase}pickups/powerPellet2.svg`,
				`${imgBase}pickups/powerPellet3.svg`,
				`${imgBase}pickups/powerPellet4.svg`,
	...
	updateExtraLivesDisplay() {
		...
		for (let i = 0; i < this.lives; i += 1) {
			...
			extraLifePic.setAttribute("src", "app/style/graphics/extra_life.png");
...
class Pickup {
	 ...
	 * @param {('pacdot'|'powerPellet1'|'powerPellet2'|'powerPellet3'|'powerPellet4'|'fruit')} type - The classification of pickup
		...
		if (this.shouldCheckForCollision()) {
			if (
				...
				if (this.type === "pacdot") {
					...
					this.type === "powerPellet1" ||
					this.type === "powerPellet2" ||
					this.type === "powerPellet3" ||
					this.type === "powerPellet4"
				) {
					window.dispatchEvent(new Event("dotEaten"));
